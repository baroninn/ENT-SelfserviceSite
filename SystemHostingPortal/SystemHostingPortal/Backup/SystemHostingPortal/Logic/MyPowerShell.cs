...
namespace SystemHostingPortal.Logic
{
    public class MyPowerShell : IDisposable
    {
        ...
        internal void SetNavCompanyName(string organization, string companyName, bool nativeDatabase, bool force)
        {
        ...
        public MyPowerShell CreateNav2goUser(CustomNav2goUser nav2goUser)
        {
            ps.AddCommand(psScriptPath + @"\Nav2go-NewDemoUser.ps1");
            ps.AddParameter("DemoUser", nav2goUser.Username);
            ps.AddParameter("DemoPwd", nav2goUser.Password);
            if (nav2goUser.NoExpiry) { ps.AddParameter("NoExpiry"); }
        ...
        public MyPowerShell GetCalendarPermissions(string organization, string identity)
        {
        ...
        public MyPowerShell SetCalendarPermissions(CustomCalendarPermssions calendarPermssions)
        {
            ...
            ps.AddParameter("Identity", calendarPermssions.Identity);
        ...
        public MyPowerShell RemoveCalendarPermissions(string organization, string identity, string[] users)
        {
        ...
        public MyPowerShell SetNavCompanyName(string organization, string navcompanyname, string navsolution, bool nativedb, bool force)
        {
            ps.AddCommand(psScriptPath + @"\SetNavCompanyName.ps1")
                .AddParameter("Organization", organization)
                .AddParameter("CompanyName", navcompanyname)
                .AddParameter("Solution", navsolution)
