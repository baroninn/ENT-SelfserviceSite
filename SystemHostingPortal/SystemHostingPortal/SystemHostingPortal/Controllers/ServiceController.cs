    ...
    public class ServiceController : Controller
    {
        ...
        public string CustomerReportCSV(string organization)
        {
            try
            {
                ...
                retStr += string.Format("<table><tr><td>Disk usage:</td><td>{0}</td></tr><tr><td>Disk quota:</td><td>{1}</td></tr><tr><td>Exchange usage:</td><td>{2} GB</td></tr><tr><td>Exchange quota:</td><td>{3:0.00} GB</td></tr><tr><td>Total disk usage:</td><td>{5} GB</td></tr><tr><td>&nbsp;</td><td>&nbsp;</td></table>", model.CustomerReport.DiskUsage, model.CustomerReport.DiskQuota, model.CustomerReport.ExchangefUsage, model.CustomerReport.ExchangefQuota, model.CustomerReport.DiskTotal);
                ...
                retStr += "<table><tr><td>&nbsp;</td></tr><tr><td>Mail Only (" + model.CustomerReport.Licenses.MailOnly.Count + ")</td></tr>";
                foreach (string user in model.CustomerReport.Licenses.MailOnly)
                {
                    retStr += "<tr><td>" + user + "</td></tr>";
                }
                retStr += "</table>";

                retStr += "<table><tr><td>&nbsp;</td></tr><tr><td>Office Standard Licenses (" + model.CustomerReport.Licenses.StudJur.Count + ")</td></tr>";
                foreach (string user in model.CustomerReport.Licenses.StudJur)
                {
                    retStr += "<tr><td>" + user + "</td></tr>";
                }
                retStr += "</table>";
