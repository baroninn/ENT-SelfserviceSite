...
namespace ColumbusPortal.Models
{
    public class AdAuthenticationService
    {
        ...
        private ClaimsIdentity CreateIdentity(UserPrincipal userPrincipal)
        {
            ...
            {
                identity.AddClaim(new Claim(ClaimTypes.NameIdentifier, userPrincipal.Name));
            }
            if (!String.IsNullOrEmpty(userPrincipal.DisplayName))
            {
                identity.AddClaim(new Claim(ClaimTypes.WindowsAccountName, userPrincipal.DisplayName));
            }
