...
namespace ColumbusPortal.Logic
{
    public static class CommonCAS
    {
        ...
        public static string GenerateShortPassword(int passwordLength = 8)
        {
            string password = "";
        ...
        public static Dictionary<string, object> GetPSObjectProperties(PSObject item)
        {
            ...
            {
                //CommonCAS.debug.Add(string.Format("Found Name: {0}, Value: {1}", property.Name, property.Value));
