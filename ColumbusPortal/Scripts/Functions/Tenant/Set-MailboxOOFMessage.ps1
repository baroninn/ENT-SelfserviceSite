function Set-MailboxOOFMessage {
    ...
    Begin {
        ...
        Import-Module (New-ExchangeProxyModule -Organization $Organization -Command "Get-Mailbox", "Get-MailboxAutoReplyConfiguration", "Set-MailboxAutoReplyConfiguration") > $null
    }
    Process {
