...
1.2       2015-10-23    Dennis Rye
    - Account can be a SID as well. This is useful for cross-forest one-way trusts
      where the native .NET classes can not resolve an account name
